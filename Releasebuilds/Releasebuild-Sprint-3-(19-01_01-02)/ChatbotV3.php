<?php
/**
 * VERSIE 3 - 13 FEBRUARI 2026
 * EERSTE GEMINI AI INTEGRATIE
 * Vervang je hele functions.php met deze code
 * Let op: Backslash problemen nog aanwezig in deze versie
 */
...
// ============================================================================
// CHATBOT CONFIG - EERSTE GEMINI VERSIE
// ============================================================================
...
// ============================================================================
// GEMINI RESPONSE FUNCTIE - EERSTE VERSIE (GEEN RETRY, GEEN HISTORY)
// ============================================================================
...
function chatbot_get_gemini_response($request) {
    ...
    $prompt = "Je bent een vriendelijke assistent voor een Nederlandse beddenwinkel.\n\nVraag: " . $message . "\n\nAntwoord:";
