<?php
/**
 * VERSIE 6 - 23 FEBRUARI 2026
 * RETRY LOGIC + RATE LIMIT HANDLING
 * Fix: 429 Rate limit wordt nu opgevangen
 * Fix: Retry loop met 3 pogingen
 * Fix: sleep(2) tussen pogingen
...
// ============================================================================
// GEMINI RESPONSE FUNCTIE - MET RETRY LOGIC
// ============================================================================
...
function chatbot_get_gemini_response($request) {
    ...
    // ✅ NIEUW: Retry loop voor 429 rate limit
    $max_retries = 3;
    $retry_count = 0;
    $response    = false;
    ...
    while (true) {
        ...
        // ✅ NIEUW: Bij 429 wacht 2 seconden en probeer opnieuw
...
// ============================================================================
// PROMPT OPBOUW - MET HISTORY (NIEUW IN V5)
// ============================================================================

function chatbot_build_prompt($user_message, $history = array()) {
    $context = '';

    // ✅ NIEUW: Gespreksgeschiedenis meegeven
