<?php
/**
 * VERSIE 5 - 13 FEBRUARI 2026
 * HARDCODED MODEL URL FIX
 * Fix: models\/gemini escaped slash opgelost
 * Fix: Geen variabelen meer voor model naam
 * Fix: URL volledig hardcoded gebouwd
...
// ============================================================================
// GEMINI RESPONSE FUNCTIE - HARDCODED URL
// ============================================================================
...
function chatbot_get_gemini_response($request) {
    ...
    // ✅ FIX: Volledig hardcoded URL - geen variabelen, geen escaping
    $api_url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=' . GEMINI_API_KEY;
