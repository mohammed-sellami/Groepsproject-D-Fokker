<?php
/**
 * VERSIE 7 - 23 FEBRUARI 2026
 * KORTE PROMPT FIX + GEMINI 2.0 FLASH
 * Fix: 400 error door te lange prompt opgelost
 * Fix: Model geupgraded naar gemini-2.0-flash
 * Fix: Prompt verkort voor stabielere responses
...
// ============================================================================
// CHATBOT CONFIG - GEMINI 2.0 FLASH
// ============================================================================

define('GEMINI_API_KEY', 'jouw-gemini-api-key-hier'); // Vervang dit door je eigen API key
...
add_action('rest_api_init', function () {
    ...
    register_rest_route('chatbot/v1', '/test-gemini', array(
        ...
        'callback'            => function () {
            ...
            // ✅ Geupgraded naar gemini-2.0-flash
...
// ============================================================================
// GEMINI RESPONSE FUNCTIE - MET RETRY + GEMINI 2.0
// ============================================================================
...
// ============================================================================
// PROMPT OPBOUW - ✅ VERKORT VOOR 400 FIX
// ============================================================================
...
function chatbot_build_prompt($user_message, $history = array()) {
    ...
    // ✅ FIX: Verkorte prompt om 400 errors te voorkomen
    $prompt = "Je bent matrasexpert voor een Nederlandse beddenwinkel.\n\n"
        . "Producten: Bremafa matrassen (pocketvering, koudschuim, latex, traagschuim).\n"
        . "Hardheden: H1 < 60kg, H2 60-80kg, H3 80-100kg, H4 > 100kg.\n"
        . "Advies: Zijslaper=H2, Rugslaper=H2-H3, Buikslaper=H3, Rugpijn=H3-H4.\n"
        . "Gedrag: Max 150 woorden, max 2 emoji, stel 1-2 vragen.\n\n"
        . $context
        . "Vraag: " . $user_message . "\n\n"
        . "Antwoord:";
