<?php
/**
 * VERSIE 4 - 13 FEBRUARI 2026
 * BACKSLASH FIX + GEMINI AI
 * Fix: Elementor\Plugin (1 backslash)
 * Fix: "\n" ipv "\\n"
 * Fix: HelloTheme\Theme (1 backslash)
...
if ( ! function_exists( 'hello_elementor_check_hide_title' ) ) {
	function hello_elementor_check_hide_title( $val ) {
		if ( defined( 'ELEMENTOR_VERSION' ) ) {
			// ✅ FIX: Elementor\Plugin (1 backslash ipv 2)
...
// ✅ FIX: HelloTheme\Theme (1 backslash ipv 2)
...
// ============================================================================
// GEMINI RESPONSE FUNCTIE - MET PROMPT MAAR NOG GEEN HISTORY/RETRY
// ============================================================================
...
function chatbot_get_gemini_response($request) {
    ...
    $prompt = chatbot_build_prompt($message);

    // ✅ FIX: Hardcoded URL zonder variabelen
    $api_url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=' . GEMINI_API_KEY;
    ...
    if (is_wp_error($response)) {
        return new WP_REST_Response(array(
            'success' => false,
            'message' => 'Verbindingsfout met AI.',
...
// ============================================================================
// PROMPT OPBOUW - EERSTE VOLLEDIGE VERSIE
// ============================================================================

function chatbot_build_prompt($user_message) {
    // ✅ FIX: "\n" ipv "\\n" overal
